...
# @Update  : 2023/10/14 19:43
# @Detail  : wwiser/wwiser/generator/wgenerator.py

import logging

from wwiser.wwiser.generator import wfilter, wmover, wreport, wtxtp_cache
from wwiser.wwiser.generator import wlang
from wwiser.wwiser.generator.render import wbuilder, wglobalsettings, wstate
from wwiser.wwiser.parser import wdefs
from . import wrenderer
...
class Generator(object):
    ...
    def _write_bank(self, bank):
        ...
        logging.debug("generator: writting bank nodes (names: %s, unnamed: %s, filtered: %s)", len(nodes_named),
                      len(nodes_unnamed), len(nodes_allow))
